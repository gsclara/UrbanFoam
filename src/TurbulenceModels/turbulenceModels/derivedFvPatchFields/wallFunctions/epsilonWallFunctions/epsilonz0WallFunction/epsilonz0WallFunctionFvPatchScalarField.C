...
#include "epsilonz0WallFunctionFvPatchScalarField.H"
...
Foam::scalar Foam::epsilonz0WallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::epsilonz0WallFunctionFvPatchScalarField::checkType()
{
...
void Foam::epsilonz0WallFunctionFvPatchScalarField::writeLocalEntries
(
    Ostream& os
) const
{
...
void Foam::epsilonz0WallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
    ...
    forAll(bf, patchi)
    {
        if (isA<epsilonz0WallFunctionFvPatchScalarField>(bf[patchi]))
        {
            epsilonz0WallFunctionFvPatchScalarField& epf = epsilonPatch(patchi);
...
Foam::epsilonz0WallFunctionFvPatchScalarField&
Foam::epsilonz0WallFunctionFvPatchScalarField::epsilonPatch(const label patchi)
{
    const volScalarField& epsilon =
        static_cast<const volScalarField&>(this->internalField());
    ...
    const epsilonz0WallFunctionFvPatchScalarField& epf =
        refCast<const epsilonz0WallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<epsilonz0WallFunctionFvPatchScalarField&>(epf);
}


void Foam::epsilonz0WallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void Foam::epsilonz0WallFunctionFvPatchScalarField::calculate
(
...
Foam::epsilonz0WallFunctionFvPatchScalarField::
epsilonz0WallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
epsilonz0WallFunctionFvPatchScalarField
(
    const epsilonz0WallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
epsilonz0WallFunctionFvPatchScalarField
(
    const epsilonz0WallFunctionFvPatchScalarField& ewfpsf
)
:
...
Foam::scalarField& Foam::epsilonz0WallFunctionFvPatchScalarField::G(bool init)
{
...
Foam::scalarField& Foam::epsilonz0WallFunctionFvPatchScalarField::epsilon
(
    bool init
)
{
...
void Foam::epsilonz0WallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::epsilonz0WallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void Foam::epsilonz0WallFunctionFvPatchScalarField::manipulateMatrix
(
