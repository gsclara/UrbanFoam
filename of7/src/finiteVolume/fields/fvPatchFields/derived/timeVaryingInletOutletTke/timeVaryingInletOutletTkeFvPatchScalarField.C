...
#include "timeVaryingInletOutletTkeFvPatchScalarField.H"
...
timeVaryingInletOutletTkeFvPatchScalarField
(
    const timeVaryingInletOutletTkeFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
timeVaryingInletOutletTkeFvPatchScalarField
(
    const timeVaryingInletOutletTkeFvPatchScalarField& pivpvf
)
:
...
void Foam::timeVaryingInletOutletTkeFvPatchScalarField::autoMap
(
...
void Foam::timeVaryingInletOutletTkeFvPatchScalarField::rmap
(
...
)
{
    ...
    const timeVaryingInletOutletTkeFvPatchScalarField& tiptf =
        refCast<const timeVaryingInletOutletTkeFvPatchScalarField>
        (ptf);
...
void Foam::timeVaryingInletOutletTkeFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::timeVaryingInletOutletTkeFvPatchScalarField::write
(
    Ostream& os
) const
{
...
void Foam::timeVaryingInletOutletTkeFvPatchScalarField::operator=
(
